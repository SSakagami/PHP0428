    ...
    <form method="post" action="update_personal.php">
      ...
      <table class="center tableborder">
        ...
        <tr>
          ...
          <td class="tableborder2"><p><input class="box" type="date" name="date" size="20" value="<?=date("Y-m-d", strtotime($result['date']))?>"></p></td>
        </tr>        
        <tr>
      ...
      <p> <input type="hidden" name="master_name" value="<?=$mname?>"> </p>
